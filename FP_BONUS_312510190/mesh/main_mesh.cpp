...
int sc_main(int argc, char* argv[])
{
    ...
    Core* m_Core5 = new Core("m_Core5", 5);
    ...
    m_Controller->flit_rx( out_flit[5][2] );
    m_Controller->valid_rx( out_valid[5][2] );
    m_Controller->ready_rx( out_ready[5][2] );
