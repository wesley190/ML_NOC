...
#include "core_ring.h"
//#include "pe.h"
#include "router_ring.h"
#include "controller_ring.h"
#include "ROM.h"
...
int sc_main(int argc, char* argv[])
{
    ...
    Core* m_Core2 = new Core("m_Core4", 2);
    Core* m_Core3 = new Core("m_Core5", 3);
    ...
    m_Controller->flit_rx( out_flit[3][2] );
    m_Controller->valid_rx( out_valid[3][2] );
    m_Controller->ready_rx( out_ready[3][2] );
    ...
    // 3: West router
    m_Router0.in_flit[3]( out_flit[3][1] ); // from router 3, east router
    m_Router0.in_valid[3]( out_valid[3][1]);
    m_Router0.in_ready[3]( out_ready[3][1]);
    // 4: North router
