        ...
        if (out_busy[1] == 0) {
            ...
            for (int i = 0; i < 5; i++) {
                ...
                if (buffer_empty[i] == 0) {
                    ...
                    /*if(Router_ID == 2 && int((sc_uint<4>)(sc_lv<4>)flit.range(27,24)) == 4 && is_head_flit){
                        channel_select[1] = i;
                        out_valid_tmp[1] = 1;
                        break;// found the flit
                    }*/
        ...
        if (out_busy[3] == 0) {
            ...
            for (int i = 0; i < 5; i++) {
                ...
                if (buffer_empty[i] == 0) {
                    ...
                    int xy_route_direct = int((sc_uint<4>)(sc_lv<4>)flit.range(27,24)) % 4;
                    bool is_head_flit = flit[33] == 1;
                    if (xy_route_direct < Router_ID%4 && is_head_flit ) {//&& Router_ID != 2
                        channel_select[3] = i;
                        out_valid_tmp[3] = 1;
                        found_flit = true;
                        break;// found the flit
                    }
                    /*if(Router_ID == 0 && xy_route_direct == 2 && is_head_flit){
                        channel_select[3] = i;
                        out_valid_tmp[3] = 1;
                        break;// found the flit
                    }*/
